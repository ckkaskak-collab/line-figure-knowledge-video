...
画法：左侧输入，中间线稿小人或怪机器处理，右侧输出，橙色箭头表达主流向。

### 系统局部

适合：信息来源、过滤器、数据库、渲染器、agent 系统局部。

画法：只画 3-5 个核心模块，线稿小人参与其中一个关键动作。
...
画法：一层层盒子，不要正式金字塔；线稿小人在旁边搬砖或搭建。

### 地图路线

适合：从想法到上线、用户路径、内容承接路径、学习路线。

画法：一条弯曲路径，少量节点，线稿小人牵线或走路。
...
3. 让线稿小人承担动作：不是站旁边，而是卡在机器里、拉错线、守门、搬运、修补、称重、扶梯子、记录、把东西塞进某个怪装置。
...
角色外观以本包 `assets/character/reference.jpg` 或本次用户指定参考为准。本包不包含上游旧角色案例，不能用上游案例替换当前角色。
...
同类主题也要换新隐喻。例如“承接路径”不一定画路线，可以画线稿小人把内容尾巴接到门把手；“一鱼多吃”不一定画鱼，可以画线稿小人把一个纸团压成几种形状。
